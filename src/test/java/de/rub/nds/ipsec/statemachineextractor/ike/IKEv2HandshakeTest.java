...
public class IKEv2HandshakeTest {
    ...
    @Test
    @Ignore
    public void testHandhakeStrongswan() throws Exception {
    ...
    @Test
    @Ignore
    public void testHandhakeCisco() throws Exception {
        IKEHandshake handshake = new IKEHandshake(500, InetAddress.getByName("10.0.3.2"), 500);
        SecurityAssociationPayloadv2 sa;
        IKEMessage answer;
