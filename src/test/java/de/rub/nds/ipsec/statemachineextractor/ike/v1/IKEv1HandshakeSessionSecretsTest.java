...
public class IKEv1HandshakeSessionSecretsTest {
    ...
    public void testComputeSecretKeys() throws Exception {
        ...
        instance.getISAKMPSA().setInitiatorNonce(DatatypeHelper.hexDumpToByteArray("4654fdd74594982a"));
        instance.getISAKMPSA().setResponderNonce(DatatypeHelper.hexDumpToByteArray("3673e64987b4956dbb8b933399251a5abf88f557a723b802b345f838667e9a4e"));
        instance.getISAKMPSA().setKeyExchangeData(DatatypeHelper.hexDumpToByteArray(""));
        instance.getISAKMPSA().setPeerKeyExchangeData(DatatypeHelper.hexDumpToByteArray(""));
        instance.getISAKMPSA().setSAOfferBody(DatatypeHelper.hexDumpToByteArray("00000001000000010000002c01010001000000240101000080010007800e0080800200028004000280030001800b0001800c7080"));
        instance.setPeerIdentificationPayloadBody(DatatypeHelper.hexDumpToByteArray("010000000a00030a"));
        instance.getISAKMPSA().setDHSecret(DatatypeHelper.hexDumpToByteArray(""));
    ...
    public void testComputeSecretKeysInformationalExchange() throws Exception {
        ...
        instance.getISAKMPSA().setInitiatorNonce(DatatypeHelper.hexDumpToByteArray("18eeeee5b29ef938"));
        instance.getISAKMPSA().setResponderNonce(DatatypeHelper.hexDumpToByteArray("cf6306dcc088a94c1983462f97a3128ecdefbe4a1925cffddedd526215648099"));
        instance.getISAKMPSA().setKeyExchangeData(DatatypeHelper.hexDumpToByteArray(""));
        instance.getISAKMPSA().setPeerKeyExchangeData(DatatypeHelper.hexDumpToByteArray(""));
        instance.getISAKMPSA().setSAOfferBody(DatatypeHelper.hexDumpToByteArray("00000001000000010000002c01010001000000240101000080010007800e0080800200028004000280030001800b0001800c7080"));
        instance.setPeerIdentificationPayloadBody(DatatypeHelper.hexDumpToByteArray("010000000a00030a"));
        instance.getISAKMPSA().setDHSecret(DatatypeHelper.hexDumpToByteArray(""));
    ...
    public void testComputeDHSecret() throws Exception {
        ...
        instance.getISAKMPSA().setDhKeyPair(new KeyPair(factory.generatePublic(key1SpecPub), factory.generatePrivate(key1SpecPriv)));
        instance.getISAKMPSA().setPeerKeyExchangeData(CryptoHelper.publicKey2Bytes(factory.generatePublic(key2SpecPub)));
        byte[] secret = instance.getISAKMPSA().computeDHSecret();
