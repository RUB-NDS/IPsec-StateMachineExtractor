...
public class IKEv1HandshakeSessionSecretsTest {
    ...
    public void testComputeDHSecret() throws Exception {
        ...
        instance.setDhKeyPair(new KeyPair(factory.generatePublic(key1SpecPub), factory.generatePrivate(key1SpecPriv)));
        instance.internalDHGroup = DHGroupAttributeEnum.GROUP2;
        instance.setPeerKeyExchangeData(CryptoHelper.publicKey2Bytes(factory.generatePublic(key2SpecPub)));
        byte[] secret = instance.computeDHSecret();
