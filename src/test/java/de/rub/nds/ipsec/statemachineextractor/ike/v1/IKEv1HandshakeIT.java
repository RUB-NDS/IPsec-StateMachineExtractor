...
public class IKEv1HandshakeIT {
    ...
    public void testMainModePKEHandshake() throws Exception {
        ...
        secrets.getISAKMPSA().setInitiatorNonce(DatatypeHelper.hexDumpToByteArray("BA4994B250A8D49F"));
        {
    ...
    public void testMoreThanOneMessageHandshake() throws Exception {
        ...
        secrets.getISAKMPSA().setInitiatorNonce(DatatypeHelper.hexDumpToByteArray("AFACCCE973091E11D016F24B36F2DD0E"));
        {
