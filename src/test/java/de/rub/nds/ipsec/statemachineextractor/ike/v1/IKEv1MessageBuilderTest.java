...
public class IKEv1MessageBuilderTest {
    ...
    public void testFromByteArray_IKEv1MainModeSecurityAssociationMessage() throws Exception {
        ...
        ISAKMPMessage instance = IKEv1MessageBuilder.fromByteArray(baos.toByteArray(), new IKEv1Ciphersuite(), new IKEv1HandshakeLongtermSecrets());
    ...
    public void testFromByteArray_IKEv1PayloadMalformedNotification() throws Exception {
        ...
        ISAKMPMessage instance = IKEv1MessageBuilder.fromByteArray(wiresharkDump, new IKEv1Ciphersuite(), new IKEv1HandshakeLongtermSecrets());
