...
public class PKCS1EncryptedISAKMPPayload extends ISAKMPPayload implements EncryptedISAKMPPayload {
    ...
    public static <T extends ISAKMPPayload> PKCS1EncryptedISAKMPPayload fromStream(Class<T> payloadType, ByteArrayInputStream bais, PrivateKey myPrivateKey, PublicKey peerPublicKey) throws GenericIKEParsingException {
        try {
