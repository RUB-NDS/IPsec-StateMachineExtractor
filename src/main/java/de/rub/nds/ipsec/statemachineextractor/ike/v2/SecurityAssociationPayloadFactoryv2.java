...
public class SecurityAssociationPayloadFactoryv2{
    ...
    public static SecurityAssociationPayload createP1SA(CipherAttributeEnum cipher, KeyLengthAttributeEnum keylength, IntegrityAttributeEnum integrity, DHGroupAttributeEnum group, PRFAttributeEnum prf) {
