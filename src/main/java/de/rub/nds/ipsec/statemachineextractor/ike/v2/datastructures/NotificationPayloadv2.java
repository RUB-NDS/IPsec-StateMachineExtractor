 ...
 */
public class NotificationPayloadv2 extends IKEv2Payload {
    ...
    public NotificationPayloadv2() {
        super(IKEPayloadTypeEnum.Notify);
    }
    ...
    public static NotificationPayloadv2 fromStream(ByteArrayInputStream bais) throws GenericIKEParsingException {
